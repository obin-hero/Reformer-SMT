...
## Edited code for habitat_sim package
...
TOP_DOWN_MAP_COLORS[MAP_SHORTEST_PATH_COLOR2] = [255, 209, 102]
...
def draw_agent(
    ...
    #return image, resized_agent, agent_center_coord
...
def get_topdown_map(
    ...
    start_height = sim.agents[0].get_state().position[1]
    ...
    for ii in range(range_x[0], range_x[1]):
        for jj in range(range_y[0], range_y[1]):
            ...
            valid_point = sim.pathfinder.is_navigable(
