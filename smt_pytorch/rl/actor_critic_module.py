...
class ActorCriticModule(nn.Module):
    def __init__(self, perception_unit, perception_out_size):
        ...
        self.critic_linear = init_(nn.Linear(perception_out_size, 1))
    ...
    def forward(self, observations, masks, cache={}):
        '''
            Returns:
