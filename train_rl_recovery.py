...
## ---------------------------------
from envs.make_env_fn import explorer_make_env_fn, vizdoom_make_env_fn, deeplab_make_env_fn, habitat_make_env_fn
from envs.multi_env import PreprocessVectorEnv, MultiWrapper
from envs.habitat_recovery_env import HabitatMultiWrapper
...
def main(cfg):
    ...
    envs = PreprocessVectorEnv(habitat_make_env_fn,
                                  env_fn_args=[(cfg,
                                                i,
                                               log_dir,
                                               visdom_name,
    ...
    envs = HabitatMultiWrapper(cfg, envs)
